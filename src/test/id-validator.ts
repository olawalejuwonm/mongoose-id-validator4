...
describe('mongoose-id-validator Integration Tests', function () {
    ...
    it('Should allow no manufacturer/colour IDs as developer can use '
        + 'mongoose required option to make these mandatory', function (done: any) {
            const c = new Car({
                name: 'Test Car'
            })
            c.save(done)
    ...
    describe('Array Duplicate Tests', function () {
        ...
        const InventoryNoDuplicates = mongoose.model('InventoryNoDuplicates',
            InventoryNoDuplicatesSchema)
        const InventoryDuplicates = mongoose.model('InventoryDuplicatesSchema',
    ...
    describe('Connection tests', function () {
        ...
        it('Correct connection should be used when specified as option',
            function (done: any) {
                ...
                async.series([
                    function (cb: any) {
                        async.parallel(mongoose.connections.map(function (c: any) {
